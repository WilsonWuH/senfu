...
import { angularEncoderAxisEccentricityErrorGuide } from "@/lib/angular-encoder-axis-eccentricity-error-guide-article";
...
export const technologyPages: Record<string, EditorialPage> = {
  ...
  "maskless-lithography-data-preparation-pattern-fidelity": masklessLithographyDataPreparationPatternFidelity,
