  ...
  return <>
    ...
    <section className="section resource-index-section">
      <div className="shell resource-grid">
        ...
        <article><span>02</span><h2>Application notes</h2><p>Engineering guides connect configuration choices to operating requirements. New: a precision-stage thermal error budget, a university cleanroom RFQ guide and a European OEM encoder qualification checklist.</p><Link className="text-link" href="/technology/linear-encoder-thermal-error-budget/">Build a linear encoder thermal budget <b>→</b></Link><Link className="text-link" href="/technology/maskless-lithography-system-rfq/">Read the maskless lithography RFQ guide <b>→</b></Link><Link className="text-link" href="/technology/optical-encoder-supplier-qualification/">Read the encoder supplier guide <b>→</b></Link></article>
